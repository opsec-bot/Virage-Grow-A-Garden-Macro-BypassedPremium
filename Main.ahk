...
;  Honestly you could just change the gamepass IDs to your own gamepass IDs and bypass that way lol
...
DeleteVerifiedUser() ; useless function
{
    global settingsFile, VERIFIED_KEY
...
CombinedVerify:
    {
        global GAME_PASS_ID, WEB_APP_URL, VERIFIED_KEY, settingsFile
        InputBox, credit200, VGAG-BizzyPremium1.01 Bypassed By @credit200, Type anything:, , 400, 130
        if (ErrorLevel)
            ExitApp

        username := "Lxrsed" ; so cheeky right?
...
LoadGUI:
    ...
    Gui, Font, s8 cD3D3D3 Bold, Segoe U
    ...
    Gui, Font, s10 cWhite Bold, Segoe UI
    Gui, Add, Link, x100 y70 w200 h24, <a href="https://github.com/opsec-bot">Credit200</a>
    Gui, Font, s8 cFFC0CB Italic, Segoe UI
    Gui, Add, Text, x100 y96 w350 h16, Bypassed the macro paywall and made it free for everyone!
    Gui, Font, s8 cWhite, Segoe UI
    Gui, Font, s10 cWhite Bold, Segoe UI
